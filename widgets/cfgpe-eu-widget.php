...
if( !class_exists('CFGPE_Eu_Widget') ) :

class CFGPE_Eu_Widget extends \Elementor\Widget_Base {
	 ...
	 */
	public function get_title() { return __('European Union control', CFGPE_NAME); }
	 ...
	 */
	public function get_categories() { return array( 'geoplugin-addons' ); }
		...
		$this->start_controls_section(
			...
			$this->add_control(
				...
				array(
					...
					'return_value' => true,
					'default' => true,
					'description' => __( 'You can chose, do you want to show or hide this widget for the European Union visitors.', CFGPE_NAME )
				)
			);
